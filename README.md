...
В данной лабораторной работе нам предложили ознакомиться с Docker. Также было предложено написать собственные образы. Я остановилась на совмещении языка программирования python с Docker. Ниже будет описание двух отдельных программ и демонстрация их работы (см. Actions). Если говорить про смысл их написания, то это обычные, ознакомительные, независимые друг от друга программы, они просты и понятны.  
